...
<head>
    <meta charset="utf-8">
    <title>INFORMATION SECURITY CONSULTING</title>
    <!-- Stylesheets -->
 ...
 <?php include('header.php');?>
        ...
        <section class="page-title" style="background-image:url(images/background/page-title-3.jpg);">
            <div class="auto-container">
                <h1>Information Security consulting</h1>
            </div>
        </section>
        <!--Page Title end-->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-3 col-sm-6">
                        <div class="welimage">
                            <img src="https://www.dcu.ie/sites/default/files/information.jpg">
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-4 col-sm-6">
                        <div class="weltext">
                            <h2>building the future together with trust
   </h2>
                             
                            <p>  We offer leading-edge technology solutions to reduce your business risks,  help  fight against cybercrime and protect proprietary data . This allows you to transform the way you manage information with the help of our team of security experts, researchers and ethical hackers.
