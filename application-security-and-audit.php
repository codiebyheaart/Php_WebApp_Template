            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-3 col-sm-6">
                        <div class="welimage">
                            <img src="https://www.readersbuzz.com/wp-content/uploads/2017/05/e-governance-newspaper.png">
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-4 col-sm-6">
                        <div class="weltext">
                            ...
                            <p>   “SMART Governance” is about the future of the public services, it’s about greater efficiency, community leadership, mobile working and continuous improvement through innovation. SMART Governance is about using technology to facilitate and support better planning and decision making. It is about improving democratic processes and transforming the ways that public services are delivered. It includes e-government, the efficiency agenda and mobile working.

<br>
Antariksha Technologies provides the “smart” in Smart Government and Smart Cities through governance, open government, decision-making, planning, procurement and performance management functionality.

<br>
Our solutions comprise of Social media analytics for government, SMART DCR(Online building Plan Scrutiny and Approval System), SMART Lighting to reduce carbon footprint and AADHAR based citizen service solutions like SRDH, SSDG etc
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <input name="username" value="" placeholder="Name of the Organisation
" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <input name="email" value="" placeholder="Contact person
" type="email">
                                        </div>
                                    </div>
									<div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <input name="phone" value="" placeholder="Mobile Number" type="text">
                                        </div>
                                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="footer-sec quick-links">
                            ...
                            <ul>
                                <li><i class="fa fa-chevron-circle-right"></i><a href="#">Meterial Engineering</a></li>
                                <li><i class="fa fa-chevron-circle-right"></i><a href="#">Mechanical Engineering</a></li>
                                <li><i class="fa fa-chevron-circle-right"></i><a href="#">Power and Energy</a></li>
                                <li><i class="fa fa-chevron-circle-right"></i><a href="#">Agricultural Processing</a></li>
                                <li><i class="fa fa-chevron-circle-right"></i><a href="#">Chemical Research</a></li>
                                <li><i class="fa fa-chevron-circle-right"></i><a href="#">Oil and Lubricant</a></li>
                    ...
                    <div class="col-md-3 latest-post col-sm-6">
                        <div class="footer-sec latest-post">
                            ...
                            <ul>
                                ...
                                <li>
                                    <img src="images\resource\post-thumb-2.jpg">
                                    <div class="content">
                                        <a href="#">Lorem ipsum dolor sit amet, consectetuer adipiscing elit</a>
                                        <span>June 12, 2017</span>
                                    </div>
                                ...
                                <li>
                                    <img src="images\resource\post-thumb-3.jpg">
                                    <div class="content">
                                        <a href="#">Lorem ipsum dolor sit amet, consectetuer adipiscing elit</a>
                                        <span>June 12, 2017</span>
                                    </div>
